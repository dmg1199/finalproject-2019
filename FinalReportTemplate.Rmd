...
```
The P value is 0.
Since the p value is 0 we can conclude that the treatment does not affect wether you contratct aids or not.we reject the nul
...
```
the inferential results for the population that uses IV Drug shows that the p value is 0.0 there fore people who use IV drugs are at higher risk to get aids.we reject the nul
...
# Discussion and Conclusion
the relationship we found was that the find of the lgbt popultaion benifited from the vaccine the most. while the other groups pretty much had they less effectiveness. we aslo found that would women should not get the treatment done because they have a higher chance of getting infected. in conclusion  the vaccibne carries pros and cons on the surten groups who get the vaccine.
<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!-->
